...
\subfigure[Ownership Phase Process]{
    \includegraphics[height = 12cm]{./Figures/Ownership.pdf} 
	\label{Figure:Owner}
   } \quad
\subfigure[Quantify Phase Process]{
    \includegraphics[height = 12cm]{./Figures/Quantify.pdf} 
...
\subfigure[Example 5x5 Pig Approach - adapted from \cite{Cox2008}]{
    \includegraphics[height = 7cm]{./Figures/PIGCox.pdf} 
	\label{Figure:PIG}
   } \quad
\subfigure[Example Methods of Developing Probability Density Functions - adapted from \cite{chapman}]{
    \includegraphics[height = 7cm]{./Figures/Hist.pdf} 
	\label{Figure:Hist}
   }
